    ...
    <div className="container mx-auto px-4 py-8 max-w-3xl">
      ...
      >
        ...
        >
              ...
              <button
                ...
                className={`absolute top-4 right-4 p-2 rounded-lg transition-all duration-200 ${
                  isBookmarked(currentCard.question_number)
                    ...
                    : 'bg-white/80 dark:bg-slate-700/80 text-gray-400 dark:text-slate-500 hover:text-amber-500 dark:hover:text-amber-400'
                }`}
                title={isBookmarked(currentCard.question_number) ? (locale === 'vi' ? 'Bỏ đánh dấu' : 'Remove bookmark') : (locale === 'vi' ? 'Đánh dấu' : 'Bookmark')}
              >
                {isBookmarked(currentCard.question_number) ? (
                ...
                {ttsSupported && (
                  <div className="flex justify-center gap-2 mt-4">
                    ...
                    <button
                      ...
                      className="flex items-center gap-1 px-3 py-1.5 rounded-full text-xs font-medium bg-white/80 dark:bg-slate-700/80 text-amber-700 dark:text-amber-300 hover:bg-white dark:hover:bg-slate-600 transition-colors shadow-sm"
                    >
                      <Volume2 className="w-3 h-3" />
                      VI
                    </button>
          ...
          >
            <Card className="h-full flex flex-col justify-center items-center p-6 bg-gradient-to-br from-green-50 to-green-100 dark:from-green-900/40 dark:to-green-800/40 border-2 border-green-200 dark:border-green-700 overflow-auto">
              <div className="text-center">
                ...
                {currentCard.explanation_vi && locale === 'vi' && (
                  <p className="mt-4 text-sm text-gray-600 dark:text-slate-400 max-w-md">
              ...
              <p className="absolute bottom-4 text-sm text-green-600 dark:text-green-300">
                {showRatingButtons
      ...
      <div className="flex items-center justify-between">
        ...
        <div className="flex gap-2">
          ...
          <Button variant="outline" onClick={handleShuffle} title="Shuffle">
